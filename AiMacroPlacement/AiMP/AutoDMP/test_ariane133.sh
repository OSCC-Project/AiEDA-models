...
python ./tuner/tuner_train.py \
        ...
        --worker \
        --worker_id 1 \
        --run_args aux_input=test/ariane133_nangate45_51/NV_ariane133_partition_c.aux gpu=1  base_ppa=test/ariane133_nangate45_51/ariane133_ppa.json  reuse_params=\"\" --density_ratio 0 \
        --congestion_ratio 0 &